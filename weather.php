                ...
                <div class="weather-place mt-5">
                    <div class="weather col-12 col-sm-10 offset-sm-1 col-md-10 offset-md-1 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                        <div class="weather-search col-12 pt-2">
                            <div class="row">
                                <h1 class="weather-name"><?= $weather_name ?></h1>
                                <div class="search-bar d-flex">
                                    <div class="input form-floating col-7 offset-2">
                                        ...
                                        <label for="floating-weather" class="floating-weather"><?= $floating_weather ?></label>
                                    </div>
                                ...
                                <div class="information">
                                    <h4 class="information-name"><?= $information_name ?></h4>
                                </div>
                                <div class="error">
                                    <h4 class="error-name"><?= $error_name ?></h4>
                                </div>
